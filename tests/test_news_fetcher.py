...
class TestFetchEventsFirst:
    ...
    def test_fetches_events_with_correct_parameters(self, mock_session):
        ...
        concept_uris = ["http://en.wikipedia.org/wiki/Bitcoin", "http://en.wikipedia.org/wiki/Bitcoin_mining"]
...
class TestFetchBitcoinMiningArticles:
    ...
    @patch('src.news_fetcher._session')
    def test_includes_sentiment_in_api_request(self, mock_session, mock_events, mock_concepts, mock_trending):
